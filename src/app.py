...
# Convert list to dict for fast lookup and add default fields
activities = {}
for activity in activities_list:
    ...
    activities[name] = {
        ...
        "time_sensitive": activity.get("time_sensitive", False),
...
@app.get("/activities")
def get_activities():
    # Return a list of activities for easier frontend handling
    return [
        {"name": name, **data}
